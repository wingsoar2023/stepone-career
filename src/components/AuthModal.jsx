...
export default function AuthModal() {
  const { showAuthModal, setShowAuthModal, loginWithGoogle, loginWithEmail, signUpWithEmail, loginAsDemoReviewer, isIOS, isSupabaseConfigured } = useAuth();
  ...
  return (
    <div style={{
      ...
      <div className="glass-card fade-in" style={{
        ...
        {/* 1-Click Demo / Reviewer Login Button (Apple Guideline 2.1 compliance) */}
        <button
          type="button"
          onClick={() => loginAsDemoReviewer()}
          style={{
            width: '100%',
            display: 'flex',
            alignItems: 'center',
        ...
        >
          ...
          <span>⚡ 1-Click Demo / Reviewer Login</span>
        </button>

        {/* Google OAuth Button: Hidden on iOS to comply with Guideline 4.8 & 4.0 */}
        {!isIOS && (
          <>
            <button
              type="button"
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.9rem' }}>
          ...
          {/* Reviewer Credentials Quick-Fill (Apple Guideline 2.1) */}
          <div style={{ textAlign: 'center', marginTop: '0.35rem' }}>
            ...
            >
              Fill Demo Credentials (alex.chen@berkeley.edu)
            </button>
          </div>
        </form>
